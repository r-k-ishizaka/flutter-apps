...
@JsonKey(fromJson: _intFromJson) int get width;@JsonKey(fromJson: _intFromJson) int get height;
/// Create a copy of NoteFileProperties
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NoteFilePropertiesCopyWith<NoteFileProperties> get copyWith => _$NoteFilePropertiesCopyWithImpl<NoteFileProperties>(this as NoteFileProperties, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NoteFileProperties&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height));
}
...
abstract mixin class $NoteFilePropertiesCopyWith<$Res>  {
  factory $NoteFilePropertiesCopyWith(NoteFileProperties value, $Res Function(NoteFileProperties) _then) = _$NoteFilePropertiesCopyWithImpl;
@useResult
$Res call({
@JsonKey(fromJson: _intFromJson) int width,@JsonKey(fromJson: _intFromJson) int height
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NoteFileProperties value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _NoteFileProperties implements NoteFileProperties {
  const _NoteFileProperties({@JsonKey(fromJson: _intFromJson) this.width = 0, @JsonKey(fromJson: _intFromJson) this.height = 0});
  factory _NoteFileProperties.fromJson(Map<String, dynamic> json) => _$NoteFilePropertiesFromJson(json);

@override@JsonKey(fromJson: _intFromJson) final  int width;
@override@JsonKey(fromJson: _intFromJson) final  int height;

/// Create a copy of NoteFileProperties
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$NoteFilePropertiesCopyWith<_NoteFileProperties> get copyWith => __$NoteFilePropertiesCopyWithImpl<_NoteFileProperties>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NoteFileProperties&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height));
}
...
/// @nodoc
abstract mixin class _$NoteFilePropertiesCopyWith<$Res> implements $NoteFilePropertiesCopyWith<$Res> {
  factory _$NoteFilePropertiesCopyWith(_NoteFileProperties value, $Res Function(_NoteFileProperties) _then) = __$NoteFilePropertiesCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(fromJson: _intFromJson) int width,@JsonKey(fromJson: _intFromJson) int height
});
