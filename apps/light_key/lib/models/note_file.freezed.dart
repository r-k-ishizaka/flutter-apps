...
mixin _$NoteFile {
  ...
  $NoteFileCopyWith<NoteFile> get copyWith =>
      _$NoteFileCopyWithImpl<NoteFile>(this as NoteFile, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is NoteFile &&
...
abstract mixin class $NoteFileCopyWith<$Res> {
  factory $NoteFileCopyWith(NoteFile value,
      $Res Function(NoteFile) _then) = _$NoteFileCopyWithImpl;
...
class _$NoteFileCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? type = null, Object? thumbnailUrl = freezed, Object? url = null, Object? blurhash = freezed, Object? isSensitive = null, Object? properties = freezed,}) {
...
extension NoteFilePatterns on NoteFile {
  ...
  TResult Function( _NoteFile value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _NoteFile extends NoteFile {
  const _NoteFile(
      {this.id = '', this.type = '', this.thumbnailUrl, this.url = '', this.blurhash, this.isSensitive = false, this.properties})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NoteFileCopyWith<_NoteFile> get copyWith =>
      __$NoteFileCopyWithImpl<_NoteFile>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _NoteFile &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.thumbnailUrl, thumbnailUrl) ||
                other.thumbnailUrl == thumbnailUrl) &&
...
/// @nodoc
abstract mixin class _$NoteFileCopyWith<$Res>
    implements $NoteFileCopyWith<$Res> {
  factory _$NoteFileCopyWith(_NoteFile value,
      $Res Function(_NoteFile) _then) = __$NoteFileCopyWithImpl;
